	...
	<div class="container-fluid">
      <div class="row">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
            <h1 class="h2"><fmt:message key="admin.activities.title">activities</fmt:message></h1>
          </div>
          <div class="table-responsive">
            <table class="table table-striped table-sm mt-3">
                <thead>
                <tr>
                    <th><fmt:message key="admin.activities.table.head.name">name</fmt:message></th>
                    <th><fmt:message key="admin.activities.table.head.actions">actions</fmt:message></th>
                </tr>
                </thead>
                <tbody>
                    <c:forEach var="act" items="${requestScope.activities}">
                        <tr>
                            <td><span>${act.name}</span></td>
                            <td>
                                <a class="px-2" style="text-decoration: none"
                                   href="${contextPath}/admin/activity/edit?id=${act.id}">
                                ...
                                <a class="px-2" style="text-decoration: none"
                                   href="${contextPath}/admin/activity/delete?id=${act.id}">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
        ...
        <c:import url="/WEB-INF/view/fragments/modal_new_activity.jsp"/>

        <c:if test="${sessionScope.activity_error_message != null}">
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <fmt:message key="${sessionScope.activity_error_message}"/>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <a href="<c:remove var='activity_error_message' scope="session"/>"
