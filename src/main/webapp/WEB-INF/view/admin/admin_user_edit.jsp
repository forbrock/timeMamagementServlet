                ...
                <div class="row">
                    <div class="col-10">
                        ...
                        <div class="form-group form-inline">
                            ...
                            <input type="password" class="form-control mb-1" id="matchingPassword"
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="isEnabled" id="flexRadioDefault1"
                                       value="true" ${requestScope.isEnabled eq true ? 'checked' : ''}>
                                <label class="form-check-label" for="flexRadioDefault1">
                                    <fmt:message key="admin.edit.user.form.radio.active">active</fmt:message>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="isEnabled" id="flexRadioDefault2"
                                       value="false" ${requestScope.isEnabled eq false ? 'checked' : ''}>
                                <label class="form-check-label" for="flexRadioDefault2">
                                    <fmt:message key="admin.edit.user.form.radio.blocked">blocked</fmt:message>
                                </label>
                            </div>
                        </div>
                    </div>
